...
public class VoiceEngine {
    ...
    public native void initvoice();
    private static native long create();
    public native int init();
    public native int startrecvaudio(int ochan,int audiochannel,int ssrc);
    public native int stoprecvaudio(int ochan,int channel,int ssrc);
    public native int startsendaudio(int channel,int ssrc);
    public native void stopsendaudio(int audioChannel,int ssrc);
