...
public class VideoEngine {
    ...
    public native int createXChannel();

    public native int deleteXChannel(int channel);
    ...
    public native int xstartrecvvideo(int ochanel, int videochannel, int ssrc, Object hwnd);

    public native int ystartrecvvideo(int ochanel, int videochannel, int ssrc, Object hwnd);

    public native void stoprecvvideo(int ochanel, int videochannel, int ssrc);

    public native int startsendvideo(int videochannel, int capid, int ssrc);

    public native int stopsendvideo(int videochannel, int capid);

    public native int startcap2();

    public native int stopcap2(int captureId);
